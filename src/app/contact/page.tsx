      ...
      <div className="bg-navy py-24 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-white/70 text-lg max-w-2xl">
            Visit our office or contact us directly to discuss your GFRC/GRC project requirements.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <div className="p-6 bg-navy/5 border border-navy/10 rounded-sm mb-6">
              <p className="text-navy font-semibold text-sm mb-1">Prefer a quick discussion?</p>
              <p className="text-gray-500 text-sm mb-5">
                Contact Durraka on WhatsApp or connect with us on LinkedIn.
              </p>
              <div className="flex flex-wrap items-center gap-3">
                ...
                <span className="text-gray-400 text-sm hidden sm:inline">{SOCIAL_LINKS.whatsapp.phone}</span>
              </div>
            </div>
