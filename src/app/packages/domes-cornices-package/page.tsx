...
const data: PackagePageData = {
  ...
  coordinationNotes: [
    'Dome geometry drawings — rise-to-span ratio, segment count, and drum-to-dome transition — should be included in the drawing set before scope can be confirmed.',
    'Cornice line positions and projection depth should be shown clearly in architectural elevations, referenced to floor levels and arched opening positions.',
    'Approximate area and quantity of repeated dome segments, cornice runs, and moulding profiles help define the pricing and technical review approach.',
    'Finish direction for dome and cornice elements — including heritage texture, contrast between surfaces, and pigment references — should be clarified before sampling.',
    'Interface zones between dome elements and the structural base, adjacent cladding, or glazed lantern should be identified and shown in drawings.',
    'Project type (mosque, hospitality, or residential) and location may affect material specifications, finish selection, and delivery coordination.',
  ],
  informationRequired: [
    'Dome geometry drawings and cross-sections (rise-to-span, segment count, drum details)',
    'Cornice line positions and profile cross-sections',
    'Architectural elevations showing full facade composition',
    'Approximate areas and quantities of each element type',
    'Design intent images or heritage reference imagery',
    'Preferred finish direction (heritage texture, stone-like, smooth)',
    'Project location and use type (mosque, hospitality, residential)',
