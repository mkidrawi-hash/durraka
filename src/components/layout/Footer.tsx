            ...
            <ul className="space-y-3.5">
              ...
              <li className="space-y-2">
                ...
                >
                  ...
                  <span><span className="text-navy/35 text-[11px]">Phone</span> {CONTACT_INFO.phone}</span>
                </a>
                <a
                  href={SOCIAL_LINKS.whatsapp.href}
                  target="_blank"
                ...
                >
                  ...
                  <span><span className="text-navy/35 text-[11px]">WhatsApp</span> {CONTACT_INFO.phone}</span>
                </a>
              </li>
              <li>
                <a
