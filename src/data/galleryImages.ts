...
export const GALLERY_IMAGES: GalleryImage[] = [
  ...
  {
    id: 'beachfront-hotel-resort-landscape-water-features-06',
    projectSlug: 'beachfront-hotel-resort-jeddah',
    ...
    packageType: 'Hospitality & Commercial Landmark Scope',
    components: ['GFRC', 'Hospitality', 'Water Features'],
    description:
      'Formal reflecting pools and palm-lined water features at the resort arrival landscape — hardscape and planter edges framing the courtyard axis.',
    image: '/images/projects/beachfront-hotel-resort-jeddah/beachfront-hotel-resort-landscape-water-features-06.jpg',
    alt: 'Formal reflecting pools with palms at a beachfront resort arrival landscape, Jeddah',
    status: 'Public Safe',
    approvedForWeb: true,
  },
  {
