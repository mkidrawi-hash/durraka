...
function GallerySlot() {
  return (
    <div className="relative aspect-[4/3] bg-navy/[0.04] border border-navy/[0.08] rounded-sm flex items-center justify-center">
      <div className="text-center">
        <svg
          className="w-5 h-5 text-navy/20 mx-auto mb-1.5"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
          aria-hidden="true"
        ...
        <p className="text-[9px] font-semibold tracking-widest uppercase text-navy/25">
          Project Reference
        </p>
      </div>
    </div>
...
export function ProjectDetailLayout({ data }: { data: ProjectPackageData }) {
  return (
    <div className="min-h-screen">

      {/* ── 1. Hero ── */}
      <section className="bg-navy pt-14 sm:pt-20 pb-10 sm:pb-16 px-4">
      ...
      {/* ── 2. Main image ── */}
      <div className="relative h-[260px] sm:h-[380px] lg:h-[480px] bg-navy">
        <Image
          src={data.heroImage}
          alt={data.title}
          fill
      ...
      <section className="bg-white py-8 sm:py-12 px-4">
        <div className="max-w-7xl mx-auto">
          <p className="text-navy/30 text-[10px] font-semibold tracking-widest uppercase mb-4">
            Project References
          </p>
          ...
          <p className="text-gray-400 text-xs mt-3 leading-relaxed">
            Additional project images available on request.
          </p>
        </div>
      </section>
