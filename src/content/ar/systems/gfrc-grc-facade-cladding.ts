...
export const facadeCladdingContentAr: SystemEnhancedData = {
  ...
  systemIntent:
    'مصمَّم لإنشاء أسطح خارجية معمارية بأشكال ومقاطع وملامس ومعالجات مخصصة للواجهات — من إيقاع الألواح وخطوط الكرانيش إلى إطارات الفتحات وتعبير الحواف.',
  ...
  designGuidance: [
    ...
    { label: 'اتجاه مقطع الكورنيش', desc: 'اختيار المقطع وعمقه وموضعه.' },
