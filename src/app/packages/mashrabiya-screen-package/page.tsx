...
const data: PackagePageData = {
  ...
  coordinationNotes: [
    'Pattern drawings or geometry files with confirmed module dimensions are required before screen panels can be accurately scoped or priced.',
    'Opening ratio and privacy performance intent should be defined early — the ratio of solid to open area affects structural capacity and manufacturing approach.',
    'Approximate screen area and the count of unique versus repeated pattern panels help determine the technical review and pricing scope.',
    'Finish direction for screen panels — including contrast with background cladding and colour performance in sun — should be confirmed before sampling.',
    'Integration with surrounding facade cladding, frame surrounds, window openings, and facade joints should be detailed clearly in the drawing set.',
    'Building orientation and climate conditions may influence opening ratio guidance, screen depth, and finish selection for long-term performance.',
  ],
  informationRequired: [
    'Mashrabiya pattern drawings or geometry files (DXF or PDF) with confirmed module dimensions',
    'Privacy and opening ratio requirements for each screen zone',
    'Facade elevations showing screen panel positions and integration with openings',
    'Approximate screen area and panel count (unique vs. repeated)',
    'Design intent images or pattern reference imagery',
    'Preferred finish direction and colour contrast intent',
    'Building orientation, sun direction, and relevant climate conditions',
